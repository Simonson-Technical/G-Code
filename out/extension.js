...
const syncView_1 = require("./commands/syncView");
const virtualFileSystem_1 = require("./virtualFileSystem");
//vscode entry point, 
function activate(context) {
    const virtualFs = new virtualFileSystem_1.VirtualFileSystemProvider();
    context.subscriptions.push(vscode.workspace.registerFileSystemProvider('syncview', virtualFs, { isCaseSensitive: false }));
    context.subscriptions.push(vscode.commands.registerCommand('g-code.syncView', (0, syncView_1.syncView)(virtualFs)));
}
